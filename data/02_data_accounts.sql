...
VALUES
    ...
    (6, 'HK12345678901234567890', 6, 'CORPORATE', 'HKD', 4200000.0, '2023-11-20', 'RESTRICTED', 'HKG001'),
    ...
    (10, 'KY12345678901234567', 10, 'TRUST', 'USD', 8750000.0, '2019-03-07', 'FROZEN', 'CYM001'),
    ...
    (13, 'US12345678901234567890', 13, 'CORPORATE', 'USD', 920000.0, '2020-06-30', 'ACTIVE', 'NYC001'),
    ...
    (16, 'CH5604835012345678009', 16, 'CORPORATE', 'CHF', 385000.0, '2018-07-19', 'ACTIVE', 'ZRH001'),
    ...
    (20, 'PA12345678901234567890', 20, 'CORPORATE', 'USD', 0.0, '2024-01-05', 'FROZEN', 'PAN001');
