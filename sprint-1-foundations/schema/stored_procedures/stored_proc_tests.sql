...
select count(*) as alerts_before from alert where transaction_id = 5;
call screen_transaction(5);
select count(*) as alerts_after from alert where transaction_id = 5;
...
select transaction_id, transaction_ref, status
from transaction
where transaction_id = 5;
...
select count(*) as alerts_before from alert where transaction_id = 18;
call screen_transaction(18);
select count(*) as alerts_after from alert where transaction_id = 18;
...
select count(*) as alerts_before from alert where transaction_id = 3;
call screen_transaction(3);
select count(*) as alerts_after from alert where transaction_id = 3;
...
-- summary
select 'summary' as result;
select transaction_id, count(*) as total_alerts, group_concat(rule_id) as rules_triggered
from alert
where transaction_id IN (5, 18, 3)
...
select match_id, transaction_id, watchlist_id, match_type, match_score, matched_value, status
